...
@Entity
@Table(name = "event_type_document")
@NamedQuery(name = "EventTypeDocument.findAll", query = "SELECT r FROM EventTypeDocument r")
public class EventTypeDocument implements Serializable {
